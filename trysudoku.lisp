...
(defclass game ()
  ((name :accessor game-name
   ...
   ;; Each location on the board contains a number from 
   ;; 1..(XBLOCKS*YBLOCKS) or is empty (i.e., contains '-)
...
in each block of the board"
  (loop for x from 0 to (- XBLOCKS 1)
     nconc (loop for y from 0 to (- YBLOCKS 1)
	     collect (loop for i from 0 to (- YBLOCKS 1)
